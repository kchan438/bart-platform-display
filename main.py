...
font_xs  = pygame.font.Font(_FONT_PATH, 11)
font_sm  = pygame.font.Font(_FONT_PATH, 13)
font_med = pygame.font.Font(_FONT_PATH, 17)

PAD     = 14   # horizontal padding (px)
ROW_H   = 54   # height of each departure row (px)
